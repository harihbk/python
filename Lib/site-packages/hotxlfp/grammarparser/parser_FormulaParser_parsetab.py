...
_lr_productions = [
  ...
  ('expression -> DECIMAL NUMBER','expression',2,'p_expression_number','parser.py',104),
  ('expression -> NUMBER DECIMAL NUMBER','expression',3,'p_expression_number','parser.py',105),
  ('expression -> NUMBER CARET NUMBER','expression',3,'p_expression_number','parser.py',106),
  ('expression -> NUMBER PERCENT','expression',2,'p_expression_number','parser.py',107),
  ('expression -> STRING','expression',1,'p_expression_string','parser.py',122),
  ('expression -> FUNCTION LPAREN RPAREN','expression',3,'p_expression_function','parser.py',128),
  ('expression -> FUNCTION LPAREN expseqcomma RPAREN','expression',4,'p_expression_wargs','parser.py',134),
  ('expression -> FUNCTION LPAREN expseqsemicolon RPAREN','expression',4,'p_expression_wargs','parser.py',135),
  ('expression -> FUNCTION LPAREN expseqbackslash RPAREN','expression',4,'p_expression_wargs','parser.py',136),
  ('expression -> array','expression',1,'p_expression_array','parser.py',142),
  ('array -> LBRACKET expseqsemicolon RBRACKET','array',3,'p_array','parser.py',148),
  ('array -> LBRACKET expseqcomma RBRACKET','array',3,'p_array','parser.py',149),
  ('array -> LBRACKET expseqbackslash RBRACKET','array',3,'p_array','parser.py',150),
  ('expseqsemicolon -> expression','expseqsemicolon',1,'p_expseq_semicolon','parser.py',156),
  ('expseqsemicolon -> SEMICOLON SEMICOLON','expseqsemicolon',2,'p_expseq_semicolon','parser.py',157),
  ('expseqsemicolon -> SEMICOLON expseqsemicolon','expseqsemicolon',2,'p_expseq_semicolon','parser.py',158),
  ('expseqsemicolon -> expseqsemicolon SEMICOLON','expseqsemicolon',2,'p_expseq_semicolon','parser.py',159),
  ('expseqsemicolon -> expseqsemicolon SEMICOLON expression','expseqsemicolon',3,'p_expseq_semicolon','parser.py',160),
  ('expseqsemicolon -> expseqsemicolon SEMICOLON SEMICOLON expression','expseqsemicolon',4,'p_expseq_semicolon','parser.py',161),
  ('expseqsemicolon -> expseqcomma SEMICOLON expseqcomma','expseqsemicolon',3,'p_expseq_semicolon','parser.py',162),
  ('expseqsemicolon -> expseqbackslash SEMICOLON expseqbackslash','expseqsemicolon',3,'p_expseq_semicolon','parser.py',163),
  ('expseqcomma -> expression','expseqcomma',1,'p_expseq_comma','parser.py',185),
  ('expseqcomma -> COMMA COMMA','expseqcomma',2,'p_expseq_comma','parser.py',186),
  ('expseqcomma -> COMMA expseqcomma','expseqcomma',2,'p_expseq_comma','parser.py',187),
  ('expseqcomma -> expseqcomma COMMA','expseqcomma',2,'p_expseq_comma','parser.py',188),
  ('expseqcomma -> expseqcomma COMMA expression','expseqcomma',3,'p_expseq_comma','parser.py',189),
  ('expseqcomma -> expseqcomma COMMA COMMA expression','expseqcomma',4,'p_expseq_comma','parser.py',190),
  ('expseqbackslash -> expression','expseqbackslash',1,'p_expseq_backslash','parser.py',210),
  ('expseqbackslash -> BACKSLASH BACKSLASH','expseqbackslash',2,'p_expseq_backslash','parser.py',211),
  ('expseqbackslash -> BACKSLASH expseqbackslash','expseqbackslash',2,'p_expseq_backslash','parser.py',212),
  ('expseqbackslash -> expseqbackslash BACKSLASH','expseqbackslash',2,'p_expseq_backslash','parser.py',213),
  ('expseqbackslash -> expseqbackslash BACKSLASH expression','expseqbackslash',3,'p_expseq_backslash','parser.py',214),
  ('expseqbackslash -> expseqbackslash BACKSLASH BACKSLASH expression','expseqbackslash',4,'p_expseq_backslash','parser.py',215),
  ('expression -> XLERROR','expression',1,'p_xlerror','parser.py',234),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_paren','parser.py',246),
  ('expression -> variable_sequence','expression',1,'p_expression_varseq','parser.py',252),
  ('variable_sequence -> VARIABLE','variable_sequence',1,'p_variable','parser.py',258),
  ('variable_sequence -> variable_sequence DECIMAL VARIABLE','variable_sequence',3,'p_variable_seq','parser.py',264),
  ('expression -> cell','expression',1,'p_expression_cell','parser.py',271),
  ('cell -> ABSOLUTE_CELL','cell',1,'p_cell','parser.py',277),
  ('cell -> RELATIVE_CELL','cell',1,'p_cell','parser.py',278),
  ('cell -> MIXED_CELL','cell',1,'p_cell','parser.py',279),
  ('cell -> ABSOLUTE_CELL COLON ABSOLUTE_CELL','cell',3,'p_cell','parser.py',280),
  ('cell -> ABSOLUTE_CELL COLON RELATIVE_CELL','cell',3,'p_cell','parser.py',281),
  ('cell -> ABSOLUTE_CELL COLON MIXED_CELL','cell',3,'p_cell','parser.py',282),
  ('cell -> RELATIVE_CELL COLON ABSOLUTE_CELL','cell',3,'p_cell','parser.py',283),
  ('cell -> RELATIVE_CELL COLON RELATIVE_CELL','cell',3,'p_cell','parser.py',284),
  ('cell -> RELATIVE_CELL COLON MIXED_CELL','cell',3,'p_cell','parser.py',285),
  ('cell -> MIXED_CELL COLON ABSOLUTE_CELL','cell',3,'p_cell','parser.py',286),
  ('cell -> MIXED_CELL COLON RELATIVE_CELL','cell',3,'p_cell','parser.py',287),
  ('cell -> MIXED_CELL COLON MIXED_CELL','cell',3,'p_cell','parser.py',288),
]
